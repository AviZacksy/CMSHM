  ...
  return (
    <>
          ...
          <div className="hidden sm:block w-full border-t border-gray-200"></div>
                              ...
                              {/* Main Navigation */}
           <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
             <div className="flex justify-between items-center py-4 sm:py-8 lg:py-12">
               ...
               {/* Desktop Navigation - New Items */}
               <nav className="hidden xl:flex space-x-8 -ml-2 sm:-ml-4 lg:-ml-6">
                 <Link href="/get-care" className="text-gray-800 hover:text-blue-600 transition-colors duration-200 font-bold text-2xl">
                   Get Care
                 </Link>
                 <Link href="/find-doctor" className="text-gray-800 hover:text-blue-600 transition-colors duration-200 font-bold text-2xl">
                   Find a Doctor
                 </Link>
                 <Link href="/locations" className="text-gray-800 hover:text-blue-600 transition-colors duration-200 font-bold text-2xl">
                   Locations
                 </Link>
                 <Link href="/specialties" className="text-gray-800 hover:text-blue-600 transition-colors duration-200 font-bold text-2xl">
                   Specialties
                 </Link>
                 <Link href="/records-billing" className="text-gray-800 hover:text-blue-600 transition-colors duration-200 font-bold text-2xl">
                   Records & Billing
                 </Link>
                 <Link href="/signin" className="text-gray-800 hover:text-blue-600 transition-colors duration-200 font-bold text-2xl">
                   Sign In
                 </Link>
               </nav>
               ...
               <div className="hidden xl:flex space-x-3 flex-shrink-0 ml-4">
                 <button className="p-4 transition-all duration-300 hover:scale-105">
